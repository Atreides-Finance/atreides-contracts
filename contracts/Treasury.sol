...
contract Treasury is Ownable {
    ...
    uint256 public sSPICEQueue; // Delays change to sSPICE address
    ...
    /**
        ...
        @param _amount uint
     */
    function repayDebtWithSPICE(uint256 _amount) external {
        require(isDebtor[msg.sender], "Not approved");
        ...
        returns (uint256 value_)
    {
        if (isReserveToken[_token]) {
            ...
            value_ = _amount.mul(10**IERC20(SPICE).decimals()).div(
        ...
        returns (bool)
    {
        ...
        } else if (_managing == MANAGING.SSPICE) {
            // 9
